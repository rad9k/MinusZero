...
{
    public class ZeroCodeEngine:IParser, IExecuter, IGraphCreationCodeGenerator
    {
...
#region GraphCreationCodeGenerate
        ...
        public string GraphCreationCodeGenerateAsString(IVertex graphRoot)
        {
        ...
        public void GraphCreationCodeGenerate(IVertex graphRoot, IVertex generationRoot)
        {
        ...
        {            
            ...
            ZeroCodeTerminals = MinusZero.Instance.DefaultLanguageMetaDefinition;
