...
namespace m0
{
    public class MinusZero:IStoreUniverse, IDisposable
    {
        ...
        void CreateSystemDataVisualiserDiagram()
        {
            ...
            civ.AddEdge(Root.Get(@"System\Meta*VisualiserClass"), Root.Get(@"System\Meta*ListVisualiser"));
            ...
            vive.AddEdge(dld.Get("DiagramLineClass"), sm.Get(@"*DiagramInternal\DiagramLine"));
